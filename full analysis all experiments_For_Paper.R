...
#### --- Preprocessing --- ####
### full analysis
s1a <- read.csv("replication1.csv") #direct replication 1
s1b <- read.csv("replication2.csv") #direct replication 2
s1c <- read.csv("MIT1.csv") #direct replication 3 (in lab)

s2a <- read.csv("replication3.csv") # 2AFC online
s2aCR <- read.csv("replication3cr.csv") # 2AFC online Correct Rejections
s2b <- read.csv("MIT2.csv") # 2AFC lab
s2bCR <- read.csv("MIT2CR.csv") # 2AFC lab CR

s3 <- read.csv("replication4.csv") # answer on absent instead of present

s4 <- read.csv("replication7.csv") # Occluder
s5 <- read.csv("replication6.csv") # Standard, with no attention check
s6 <- read.csv("replication9.csv") # Standard; attention check at agent re-enter (19s for all movies)
s7 <- read.csv("replication11.csv") # No agent; attention check on lightbulb instead of agent.
s8 <- read.csv("replication12_2.csv") # Standard; attention check on lightbulb at various timings
#s8a <- read.csv("replication12.csv") # Standard; attention check on lightbulb at various timings
#s8b <- read.csv("replication12_2.csv") # Standard; attention check on lightbulb at various timings
